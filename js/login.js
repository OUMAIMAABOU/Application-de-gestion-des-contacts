...
function validation(){
    ...
    if(password.value=="" ){
        ...
        img2.innerHTML='<img src="img/error.svg.png" style="POSITION: relative;top:-49px;right:-395px;width: 39px;">'
    ...
    if(passwordver.value=="" ){
        ...
        document.getElementById('pass').innerHTML ="Password does'nt Match!"
        img22.innerHTML='<img src="img/error.svg.png" style="POSITION: relative;top:-49px;right:-395px;width: 39px;">'
